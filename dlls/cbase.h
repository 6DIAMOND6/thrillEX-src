...
#define		FCAP_USE_THROUGH_BSP		0x40000000		// Player can use this object without traceline check
...
//	virtual void	SetActivator( CBaseEntity *pActivator ) {}
	...
	virtual void SUB_StartFadeIn ( void );
	virtual void SUB_FadeIn ( void );
	void EXPORT SUB_CallUseToggle( void ) { this->Use( this, this, USE_TOGGLE, 0 ); }
	int			ShouldToggle( USE_TYPE useType, BOOL currentState );
	void		FireBullets( ULONG	cShots, Vector  vecSrc, Vector	vecDirShooting,	Vector	vecSpread, float flDistance, int iBulletType, int iTracerFreq = 4, int iDamage = 0, entvars_t *pevAttacker = NULL  );
	Vector		FireBulletsPlayer( ULONG cShots, Vector  vecSrc, Vector	vecDirShooting,	Vector	vecSpread, float flDistance, int iBulletType, int iTracerFreq = 4, int iDamage = 0, entvars_t *pevAttacker = NULL, int shared_rand = 0, int iForceImpact = 0);
...
typedef struct locksounds			// sounds that doors and buttons make when locked/unlocked
{
	...
	float	flwaitLockedMessage;	// SERECKY JAN-15-26: NEW
...
#define MAINGIB_NONE		0
#define	MAINGIB_HUMAN		1// hgibs
#define MAINGIB_ALIEN		2// agibs

#define STICKYGIB_NONE		0// no stickygibs at all
#define STICKYGIB_NORMAL	1// meat stickygibs
#define STICKYGIB_PINK		2// brain stickygibs

#define SPECIALGIB_NONE		0// no special gib
#define SPECIALGIB_AGRUNT	1// alien grunt head
#define SPECIALGIB_HGRUNT	2// human grunt leg
#define SPECIALGIB_HOUNDEYE	3// houndeye's... head?
#define SPECIALGIB_ZOMBIE	4// zombie leg
#define SPECIALGIB_ISLAVE	5// alien slave hand
