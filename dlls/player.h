...
public:
	...
	BOOL	IsBarnaclePrey() { return TRUE; }
...
// these are time-sensitive things that we keep track of
	...
	int			m_iLadderMode;	// NEW - serecky 1.14.26
	int			m_iClientROF;	// NEW
	// usable player items 
