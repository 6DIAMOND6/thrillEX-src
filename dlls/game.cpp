...
// New cvars - serecky 1.4.26
cvar_t	knockback			= {"sv_knockback", "1",  FCVAR_SERVER };
cvar_t	holster				= {"sv_holster", "1",  FCVAR_SERVER };
cvar_t	headcrab_dmg		= {"sv_headcrab_dmg", "2",  FCVAR_SERVER };
cvar_t	original_rof		= {"sv_original_rof", "0",  FCVAR_SERVER };
cvar_t	ladder_mode			= {"sv_ladder_mode", "1", FCVAR_SERVER };
...
cvar_t	sk_archer_dmg_bite1 = {"sk_archer_dmg_bite1","0"};
cvar_t	sk_archer_dmg_bite2 = {"sk_archer_dmg_bite2","0"};
cvar_t	sk_archer_dmg_bite3 = {"sk_archer_dmg_bite3","0"};

cvar_t	sk_archer_min_beam_delay1 = {"sk_archer_min_beam_delay1","0"};
cvar_t	sk_archer_min_beam_delay2 = {"sk_archer_min_beam_delay2","0"};
cvar_t	sk_archer_min_beam_delay3 = {"sk_archer_min_beam_delay3","0"};

cvar_t	sk_archer_dmg_zap1 = {"sk_archer_dmg_zap1","0"};
cvar_t	sk_archer_dmg_zap2 = {"sk_archer_dmg_zap2","0"};
cvar_t	sk_archer_dmg_zap3 = {"sk_archer_dmg_zap3","0"};
...
// Bloater
cvar_t	sk_bloater_health1 = {"sk_bloater_health1","0"};
cvar_t	sk_bloater_health2 = {"sk_bloater_health2","0"};
cvar_t	sk_bloater_health3 = {"sk_bloater_health3","0"};

cvar_t	sk_bloater_dmg_bolt1 = {"sk_bloater_dmg_bolt1","0"};
...
cvar_t	sk_hassault_spinup_delay1 = {"sk_hassault_spinup_delay1","0"};
cvar_t	sk_hassault_spinup_delay2 = {"sk_hassault_spinup_delay2","0"};
cvar_t	sk_hassault_spinup_delay3 = {"sk_hassault_spinup_delay3","0"};

cvar_t	sk_hassault_dmg_cannon1 = {"sk_hassault_dmg_cannon1","0"};
cvar_t	sk_hassault_dmg_cannon2 = {"sk_hassault_dmg_cannon2","0"};
cvar_t	sk_hassault_dmg_cannon3 = {"sk_hassault_dmg_cannon3","0"};
...
cvar_t sk_kingpin_dmg_claw1 = {"sk_kingpin_dmg_claw1","0"};
cvar_t sk_kingpin_dmg_claw2 = {"sk_kingpin_dmg_claw2","0"};
cvar_t sk_kingpin_dmg_claw3 = {"sk_kingpin_dmg_claw3","0"};

cvar_t sk_kingpin_dmg_zap1 = {"sk_kingpin_dmg_zap1","0"};
cvar_t sk_kingpin_dmg_zap2 = {"sk_kingpin_dmg_zap2","0"};
cvar_t sk_kingpin_dmg_zap3 = {"sk_kingpin_dmg_zap3","0"};
...
// Snapbug
cvar_t	sk_snapbug_health1 = {"sk_snapbug_health1","0"};
cvar_t	sk_snapbug_health2 = {"sk_snapbug_health2","0"};
cvar_t	sk_snapbug_health3 = {"sk_snapbug_health3","0"};

cvar_t	sk_snapbug_dmg_bite1 = {"sk_snapbug_dmg_bite1","0"};
cvar_t	sk_snapbug_dmg_bite2 = {"sk_snapbug_dmg_bite2","0"};
cvar_t	sk_snapbug_dmg_bite3 = {"sk_snapbug_dmg_bite3","0"};
...
cvar_t	sk_diablo_dmg_slash1 = {"sk_diablo_dmg_slash1","0"};
cvar_t	sk_diablo_dmg_slash2 = {"sk_diablo_dmg_slash2","0"};
cvar_t	sk_diablo_dmg_slash3 = {"sk_diablo_dmg_slash3","0"};

cvar_t	sk_diablo_dmg_jump1 = {"sk_diablo_dmg_jump1","0"};
cvar_t	sk_diablo_dmg_jump2 = {"sk_diablo_dmg_jump2","0"};
cvar_t	sk_diablo_dmg_jump3 = {"sk_diablo_dmg_jump3","0"};
...
cvar_t	sk_friendly_dmg_slash1 = {"sk_friendly_dmg_slash1","0"};
cvar_t	sk_friendly_dmg_slash2 = {"sk_friendly_dmg_slash2","0"};
cvar_t	sk_friendly_dmg_slash3 = {"sk_friendly_dmg_slash3","0"};

cvar_t	sk_friendly_dmg_spit1 = {"sk_friendly_dmg_spit1","0"};
cvar_t	sk_friendly_dmg_spit2 = {"sk_friendly_dmg_spit2","0"};
cvar_t	sk_friendly_dmg_spit3 = {"sk_friendly_dmg_spit3","0"};

// Stuka
cvar_t	sk_stuka_health1 = {"sk_stuka_health1","0"};
cvar_t	sk_stuka_health2 = {"sk_stuka_health2","0"};
cvar_t	sk_stuka_health3 = {"sk_stuka_health3","0"};

cvar_t	sk_stuka_dmg_slash1 = {"sk_stuka_dmg_slash1","0"};
cvar_t	sk_stuka_dmg_slash2 = {"sk_stuka_dmg_slash2","0"};
cvar_t	sk_stuka_dmg_slash3 = {"sk_stuka_dmg_slash3","0"};

cvar_t	sk_stuka_dmg_bomb1 = {"sk_stuka_dmg_bomb1","0"};
cvar_t	sk_stuka_dmg_bomb2 = {"sk_stuka_dmg_bomb2","0"};
cvar_t	sk_stuka_dmg_bomb3 = {"sk_stuka_dmg_bomb3","0"};
...
// Syringes
cvar_t sk_adrenaline_carry1 = { "sk_adrenaline_carry1","0" };
cvar_t sk_adrenaline_carry2 = { "sk_adrenaline_carry2","0" };
cvar_t sk_adrenaline_carry3 = { "sk_adrenaline_carry3","0" };

cvar_t sk_radiation_carry1 = { "sk_radiation_carry1","0" };
cvar_t sk_radiation_carry2 = { "sk_radiation_carry2","0" };
cvar_t sk_radiation_carry3 = { "sk_radiation_carry3","0" };

cvar_t sk_antidote_carry1 = { "sk_antidote_carry1","0" };
cvar_t sk_antidote_carry2 = { "sk_antidote_carry2","0" };
cvar_t sk_antidote_carry3 = { "sk_antidote_carry3","0" };
...
cvar_t	sk_longjumpbat1 = { "sk_longjumpbat1","1" };
cvar_t	sk_longjumpbat2 = { "sk_longjumpbat2","1" };
cvar_t	sk_longjumpbat3 = { "sk_longjumpbat3","1" };
...
void GameDLLInit( void )
{
	...
	// so here's some cool new cvars im adding...
	// - serecky 1.4.26

	CVAR_REGISTER (&knockback);
	CVAR_REGISTER (&holster);
	CVAR_REGISTER (&headcrab_dmg);
	CVAR_REGISTER (&original_rof);
	CVAR_REGISTER (&ladder_mode);
...
// REGISTER CVARS FOR SKILL LEVEL STUFF
	...
	// Archer
	CVAR_REGISTER ( &sk_archer_health1 );// {"sk_archer_health1","0"};
	CVAR_REGISTER ( &sk_archer_health2 );// {"sk_archer_health2","0"};
	CVAR_REGISTER ( &sk_archer_health3 );// {"sk_archer_health3","0"};

	CVAR_REGISTER ( &sk_archer_dmg_bite1 );// {"sk_archer_dmg_bite1","0"};
	CVAR_REGISTER ( &sk_archer_dmg_bite2 );// {"sk_archer_dmg_bite2","0"};
	CVAR_REGISTER ( &sk_archer_dmg_bite3 );// {"sk_archer_dmg_bite3","0"};

	CVAR_REGISTER ( &sk_archer_min_beam_delay1 );// {"sk_archer_min_beam_delay1","0"};
	CVAR_REGISTER ( &sk_archer_min_beam_delay2 );// {"sk_archer_min_beam_delay2","0"};
	CVAR_REGISTER ( &sk_archer_min_beam_delay3 );// {"sk_archer_min_beam_delay3","0"};

	CVAR_REGISTER ( &sk_archer_dmg_zap1 );// {"sk_archer_dmg_zap1","0"};
	CVAR_REGISTER ( &sk_archer_dmg_zap2 );// {"sk_archer_dmg_zap2","0"};
	CVAR_REGISTER ( &sk_archer_dmg_zap3 );// {"sk_archer_dmg_zap3","0"};
	...
	// Bloater
	CVAR_REGISTER ( &sk_bloater_health1 );
	CVAR_REGISTER ( &sk_bloater_health2 );
	CVAR_REGISTER ( &sk_bloater_health3 );
	...
	CVAR_REGISTER ( &sk_hassault_spinup_delay1 );
	CVAR_REGISTER ( &sk_hassault_spinup_delay2 );
	CVAR_REGISTER ( &sk_hassault_spinup_delay3 );

	CVAR_REGISTER ( &sk_hassault_dmg_cannon1 );
	CVAR_REGISTER ( &sk_hassault_dmg_cannon2 );
	CVAR_REGISTER ( &sk_hassault_dmg_cannon3 );
	...
	CVAR_REGISTER ( &sk_kingpin_dmg_claw1 );
	CVAR_REGISTER ( &sk_kingpin_dmg_claw2 );
	CVAR_REGISTER ( &sk_kingpin_dmg_claw3 );

	CVAR_REGISTER ( &sk_kingpin_dmg_zap1 );
	CVAR_REGISTER ( &sk_kingpin_dmg_zap2 );
	CVAR_REGISTER ( &sk_kingpin_dmg_zap3 );
	...
	// Snapbug
	CVAR_REGISTER ( &sk_snapbug_health1 );
	CVAR_REGISTER ( &sk_snapbug_health2 );
	CVAR_REGISTER ( &sk_snapbug_health3 );

	CVAR_REGISTER ( &sk_snapbug_dmg_bite1 );
	CVAR_REGISTER ( &sk_snapbug_dmg_bite2 );
	CVAR_REGISTER ( &sk_snapbug_dmg_bite3 );
	...
	CVAR_REGISTER ( &sk_diablo_dmg_slash1 );
	CVAR_REGISTER ( &sk_diablo_dmg_slash2 );
	CVAR_REGISTER ( &sk_diablo_dmg_slash3 );

	CVAR_REGISTER ( &sk_diablo_dmg_jump1 );
	CVAR_REGISTER ( &sk_diablo_dmg_jump2 );
	CVAR_REGISTER ( &sk_diablo_dmg_jump3 );
	...
	CVAR_REGISTER ( &sk_friendly_dmg_slash1 );
	CVAR_REGISTER ( &sk_friendly_dmg_slash2 );
	CVAR_REGISTER ( &sk_friendly_dmg_slash3 );

	CVAR_REGISTER ( &sk_friendly_dmg_spit1 );
	CVAR_REGISTER ( &sk_friendly_dmg_spit2 );
	CVAR_REGISTER ( &sk_friendly_dmg_spit3 );

	// Stuka
	CVAR_REGISTER ( &sk_stuka_health1 );
	CVAR_REGISTER ( &sk_stuka_health2 );
	CVAR_REGISTER ( &sk_stuka_health3 );

	CVAR_REGISTER ( &sk_stuka_dmg_slash1 );
	CVAR_REGISTER ( &sk_stuka_dmg_slash2 );
	CVAR_REGISTER ( &sk_stuka_dmg_slash3 );

	CVAR_REGISTER ( &sk_stuka_dmg_bomb1 );
	CVAR_REGISTER ( &sk_stuka_dmg_bomb2 );
	CVAR_REGISTER ( &sk_stuka_dmg_bomb3 );
...
// Syringes
	CVAR_REGISTER ( &sk_adrenaline_carry1 );
	CVAR_REGISTER ( &sk_adrenaline_carry2 );
	CVAR_REGISTER ( &sk_adrenaline_carry3 );

	CVAR_REGISTER ( &sk_radiation_carry1 );
	CVAR_REGISTER ( &sk_radiation_carry2 );
	CVAR_REGISTER ( &sk_radiation_carry3 );

	CVAR_REGISTER ( &sk_antidote_carry1 );
	CVAR_REGISTER ( &sk_antidote_carry2 );
	CVAR_REGISTER ( &sk_antidote_carry3 );
...
// player damage adjusters
	...
	CVAR_REGISTER ( &sk_longjumpbat1 );
	CVAR_REGISTER ( &sk_longjumpbat2 );
	CVAR_REGISTER ( &sk_longjumpbat3 );
