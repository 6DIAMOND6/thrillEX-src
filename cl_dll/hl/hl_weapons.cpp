...
//extern "C"
//{
//	unsigned short g_usLadderClimb;
//}

// New - serecky 1.10.26
extern int g_iOriginalROF;

int IsOriginalROFOn(void)
{
	return g_iOriginalROF;
}
...
void HUD_InitClientWeapons( void )
{
	...
	HUD_PrepEntity( &g_Chub		,&player );
#ifdef XM_WEAPONS
	HUD_PrepEntity( &g_Flare	, &player );
#endif

	//g_usLadderClimb = PRECACHE_EVENT(1, "events/ladder.sc" );
}
